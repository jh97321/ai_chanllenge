...
def re_ranking(input_feature_source,input_feature,k1=20,k2=6,lambda_value=0.2, MemorySave = False, Minibatch = 2000, no_rerank=False):
    ...
    print('computing source distance...', end='/r', flush=True)
    ...
    print('computing original distance...', end='/r', flush=True)
    if MemorySave:
    ...
    print('starting re_ranking...', end='/r', flush=True)
    for i in range(all_num):
    ...
    #final_dist = float(jaccard_dist*(1-lambda_value) + source_dist*lambda_value)
    del original_dist
    del V
    del jaccard_dist
